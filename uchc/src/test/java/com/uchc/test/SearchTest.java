...
public class SearchTest {
    ...
    public void byDoctorCheckResults() {
        ...
        Assert.assertTrue(checkIndividualResult(serp, true, true));
    }
    ...
    public void byDentistCheckResults() {
        ...
        Assert.assertTrue(checkIndividualResult(serp,false, true));
    }
    ...
    public void byPodiatristCheckResults() {
        ...
        Assert.assertTrue(checkIndividualResult(serp,false,false));
    }
    ...
    private boolean checkIndividualResult(SearchResultsPage serp, boolean hasRating, boolean hasReport) {
        boolean result = true;
        int rand;
        String name;
